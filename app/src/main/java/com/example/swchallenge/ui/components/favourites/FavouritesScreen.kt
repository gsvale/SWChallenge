...
@Composable
fun FavouritesScreen(viewModel: FavouritesViewModel, onItemClick : (String) -> Unit) {

    val state = viewModel.state.collectAsStateWithLifecycle().value

    ConstraintLayout(Modifier.fillMaxSize()) {

        val (loadingRef, titleRef, averageLifeSpanRef, gridRef) = createRefs()
        ...
        when {
            state.isLoading -> {
                ...
                state.catsList.let { favouritesList ->
